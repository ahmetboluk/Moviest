...
public class TabFour extends Fragment implements BottomTabLayotListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        api.create(TmdbApi.class).listUpComing(API_KEY,page).enqueue(new Callback<PageData>() {
            @Override
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (totalItemCount > 0 && endHasBeenReached) {
                    ...
                    if(SELECTED==SELECTED_MOVIE){
                        ...
                        api.create(TmdbApi.class).listSeriesOnTheAir(API_KEY,page).enqueue(new Callback<SeriesPageData>() {
                            @Override
