...
import com.example.ahmetboluk.moviest.data.seriesDetail.Result;
import com.example.ahmetboluk.moviest.R;

import java.util.List;

public class SimilarSeriesAdapter extends RecyclerView.Adapter<SimilarSeriesAdapter.MyViewHolder>{

    private Context mContect;
    private List<Result> resultList;

    public SimilarSeriesAdapter(Context context, List<Result> result){
        mContect=context;
        resultList=result;
